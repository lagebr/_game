...
public class LevelGenerator {
	 ...
	 * <li>
	 * <ul>
	 * PanicHostile - 70% probability
	 * </ul>
	 * <ul>
	 * TriangleHostile - 20% probability
	 * </ul>
	 * <ul>
	 * ChargeHostile - 10% probability
	 * </ul>
	 * </li>
	 * 
	 * @param location
	...
	public static Hostile createRandomHostile(Vector2 location, World world, Player player) {
		...
		if (number < 60) { // 60% probability
			...
			hostile = new PanicHostile(location.x, location.y, 50, 50, texture, world, player);
		} else if (number < 80) { // 80% - 60% = 20% probability
			Texture texture = new Texture(Gdx.files.internal("triangle_hostile.png"));
			hostile = new TriangleHostile(location.x, location.y, texture, world, player);
			...
			hostile = new ChargeHostile(location.x, location.y, 60, texture, world, player);
		}
